...
Use the `documentor` agent workflow:

1. Read every doc file: `AGENTS.md`, `.github/copilot-instructions.md`, `README.md`, `docs/features/*.md`
...
5. Cross-check consistency: `AGENTS.md` → `copilot-instructions.md` → `docs/features/*.md`
